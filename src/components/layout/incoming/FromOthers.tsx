...
import { RowData } from "@/components/utils/FromOthersGoogleSheet";
import { FromOthersUseData } from "@/components/classes/FromOthersDataProvider";
import { IoMdClose } from "react-icons/io";

// Define props interface
interface FromOthersProps { }

const FromOthers: React.FC<FromOthersProps> = () => {
    const { fromOthersLoading, fromOthersData, fromOthersError, fetchFromOthersData } = FromOthersUseData();
    ...
    useEffect(() => {
        if (!fromOthersLoading && fromOthersData) {
            setRowData(fromOthersData);
            setLoading(false);
        } else if (fromOthersError) {
            setErrors(fromOthersError);
            setLoading(false);
        }
    }, [fromOthersLoading, fromOthersData, fromOthersError]);
        ...
        <div className={`transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div className="flex flex-wrap">
                <div className="w-full md:w-2/3">
                    ...
                    <Spin spinning={fromOthersLoading} size="large">
