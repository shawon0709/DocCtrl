...
import {ToOthersUseData} from '../../classes/ToOthersDataProvider'
import { RowData } from "@/components/utils/ToOthersGoogleSheet";

// Define props interface
interface ToOthersProps { }



const ToOthers: React.FC<ToOthersProps> = () => {
    ...
    const { toOthersLoading, toOthersData, toOthersError } = ToOthersUseData();
    ...
    useEffect(() => {
        if (!toOthersLoading && toOthersData) {
            setRowData(toOthersData);
            setLoading(false);
        } else if (toOthersError) {
            setErrors(toOthersError);
            setLoading(false);
        }
    }, [toOthersLoading, toOthersData, toOthersError]);
                ...
                <div className="w-full md:w-2/3">
                    <div className="p-1">
                        <div className="bg-white p-4 rounded-lg shadow-md">
                            <Spin spinning={toOthersLoading} size="large">
